...
url = "https://github.com/rock6064/text/blob/another/text.txt"
...
driver.get("https://www.instagram.com/soul_ronak/")
time.sleep(2)
driver.execute_script("window.scrollTo(0, 312)")
time.sleep(2)
driver.find_element_by_link_text("follow-fast.web.app").click()
...
time.sleep(6)
driver.execute_script("window.scrollTo(0, -478)")
time.sleep(7)
